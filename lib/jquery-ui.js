 ...
 * @param {EffectDirection} direction shake direction - A value of "left" or "right" will shake the element horizontally, and a value of "up" or "down" will shake the element vertically. The value specifies which direction the element should move along the axis for the first step of the effect.
 ...
 * @param {EffectDirection} direction blind direction
 * @returns {Effect}
 */
 ...
 * @param {Number$} duration duration in ms - how long the animation will run
 * @param {ClipDirection} direction - The plane in which the clip effect will hide or show its element.
 * @returns {Effect}
 */
