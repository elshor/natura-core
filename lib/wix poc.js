...
* @param {Container} container select container - when user hovers over this container then the action is triggered
**/
...
* @param {Component} component component to hide (pathOptions:/$parent/$parent/event/container/children)
**/
...
* @change change-transformation /,/component,/$parent/$parent/$parent/event/container
* @delete delete-transformation /component,/$parent/$parent/$parent/event/container
* @property {Component}  component component to transform - the component that is the child of the container to animate (pathOptions:/$parent/$parent/$parent/$parent/event/container/children)
