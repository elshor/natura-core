...
function registerPackage(dictionary, pkg) {
  ...
  Object.entries(pkg.assertions || {}).forEach(function (_ref) {
...
function generatePropertyEntry(prop, _ref5) {
  var role = _ref5.role;
  var ret = {
...
function registerTypes(dictionary, pkg) {
  (pkg.types || []).forEach(function (t) {
    ...
    if (t.generateGetters) {
      Object.entries(t.properties || []).forEach(function (_ref6) {
...
function registerExpressions(dictionary, pkg) {
  ...
  var expressions = Array.isArray(pkg === null || pkg === void 0 ? void 0 : pkg.expressions) ? pkg.expressions : Array.isArray(pkg === null || pkg === void 0 ? void 0 : (_pkg$expressions = pkg.expressions) === null || _pkg$expressions === void 0 ? void 0 : _pkg$expressions.members) ? pkg.expressions.members : [];
  expressions.forEach(function (t) {
    dictionary._registerType(t.name, t, pkg);
