...
function registerExpressions(dictionary, pkg) {
  var _pkg$expressions, _pkg$expressions2;
  dictionary.logger.log('in registerExpressions. members is', pkg === null || pkg === void 0 ? void 0 : (_pkg$expressions = pkg.expressions) === null || _pkg$expressions === void 0 ? void 0 : _pkg$expressions.members);
  if (Array.isArray(pkg === null || pkg === void 0 ? void 0 : pkg.expressions)) {
    return registerExpressions(dictionary, pkg.expressions);
  }
  if (Array.isArray(pkg === null || pkg === void 0 ? void 0 : (_pkg$expressions2 = pkg.expressions) === null || _pkg$expressions2 === void 0 ? void 0 : _pkg$expressions2.members)) {
