...
var _default = [{
  ...
  properties: {
    ...
    title: {
      type: 'string',
      noSuggestions: true,
      description: 'human friendly name of component'
    },
    description: {
      type: 'richtext',
  ...
  properties: {
    ...
    title: {
      type: 'string',
      noSuggestions: true,
      description: 'human friendly name of type'
    },
    description: {
      type: 'richtext'
    }
...
function registerPackage(dictionary, script, pkg) {
  (script.components || []).forEach(function (component) {
...
function registerCategories(dictionary, categories) {
  Object.entries(categories).forEach(function (_ref) {
    ...
    (members || []).forEach(function (member) {
      return dictionary._registerIsa(member, category);
    });
  });
}
