...
function Rule(name, symbols, postprocess, description, source, preprocess) {
  var noSuggest = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : false;
...
Grammar.fromCompiled = function (rules, start) {
  ...
  var rules = rules.map(function (r) {
    return new Rule(r.name, r.symbols, r.postprocess, r.description, r.source, r.preprocess, r.noSuggest);
  });
